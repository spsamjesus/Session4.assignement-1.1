package com.example.android.session4assignment1;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAscButton = (Button) findViewById(R.id.btnascen);
        mDescButton = (Button) findViewById(R.id.descen);
        mNameListView = (ListView) findViewById(R.id.list_item);
        ...
        stringAdapter = new StringAdapter(MainActivity.this, R.layout.textview, stringList);
    ...
    private class StringAdapter extends ArrayAdapter<String> {
        ...
        public StringAdapter(MainActivity context, int textViewResourceId,
